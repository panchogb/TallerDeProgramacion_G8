...
/**
 * 
 * Esta clase se encarga de crear una ventana para la interfaz de usuario
 *
 */
...
public class UI extends JFrame implements ActionListener,MouseListener,IVista{
	...
	/**
	 * Este metodo se encarga de recibir las interacciones con los distintos botones de la ventana
	 */
	...
	public void desactivaManguera1() {
		...
		informar("Acumulado de la manguera 1: "+this.negocio.getAcumuladoManguera1()+" litros");
	}
	public void desactivaManguera2() {
		this.negocio.activaManguera2();
		informar("Acumulado de la manguera 2: "+this.negocio.getAcumuladoManguera2()+" litros");
	}
	
	/**
	 * Este metodo se encarga de informar en la ventana las operaciones realizadas
	 */
