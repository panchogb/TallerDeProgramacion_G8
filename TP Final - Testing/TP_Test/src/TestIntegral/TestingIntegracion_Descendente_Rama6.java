...
public class TestingIntegracion_Descendente_Rama6 {
	...
	private ArrayList<Prestacion> prestaciones2;
	...
	public void Test()
	{
		Clinica.getInstance().reporteMedico(medico, new GregorianCalendar(2021,11,1), new GregorianCalendar(2021,11,30));
	}
