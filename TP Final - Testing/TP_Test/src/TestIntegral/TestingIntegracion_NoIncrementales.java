...
public class TestingIntegracion_NoIncrementales {
	...
	public void Test()
	{
		...
		Iterator<Paciente> it = Clinica.getInstance().getPacientes().getPacientesBD().iterator();		
		
		Assert.assertEquals(it.next(), paciente1);
		Assert.assertEquals(it.next(), paciente2);
