...
public class Vista extends JFrame implements IVista  {
	...
	public Vista() {
		...
		this.btnNewButton_PersistirPacientes.setName("btnPersistirPacientes");
		this.tabbedPane.setName("agregarMedicoTab");
		this.textField_nombre.setName("nombreTextField");
		this.textField_apellido.setName("apellidoTextField");
		this.textField_dni.setName("dniTextField");
		this.textField_ciudad.setName("ciudadTextField");
		this.textField_domicilio.setName("domicilioTextField");
		this.textField_telefono.setName("telefonoTextField");
		this.textField_matricula.setName("matriculaTextField");
		this.textField_especialidad.setName("especialidadTextField");
		this.textField_posgrado.setName("posgradoTextField");
		this.textField_contratacion.setName("contratacionTextField");
		this.btnNewButton_agregarMedico.setName("btnAgregarMedico");
	}
